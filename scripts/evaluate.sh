...
python main.py --csv example_data.csv --mlflow-experiment ner_nohp --mlflow-system-prompt-id NER_System@basic --mlflow-user-prompt-id NER_User@basic --strategy openai-slim --model-name Qwen/Qwen3-14B;
python main.py --csv example_data.csv --mlflow-experiment ner_nohp --mlflow-system-prompt-id NER_System@entity --mlflow-user-prompt-id NER_User@entity --strategy openai-slim --model-name Qwen/Qwen3-14B;
